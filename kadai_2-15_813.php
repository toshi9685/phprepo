...
<body>
<h1>掲示板</h1>
<form type = "kadai_2-15_813.php" method = "post" name="form1" onsubmit = "return check()">
...
<form type = "kadai_2-15_813.php" method = "post" name="form2" onsubmit = "return submitChk()">
投稿編集:<input type = "text" name = "edit">
パスワード:<input type ="text" name = "pass">
<input type ="submit" value ="送信"><br>
</form>
<form type = "kadai_2-15_813.php" method = "post" name="form3" onsubmit = "return submitChk()">
